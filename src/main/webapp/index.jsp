...
<body>
	...
	<h2 style="color: pink; font-size: 40px;" align="center">Happy new year</h2>
	<h2 style="color: black; font-size: 40px;" align="center">we integrated with nexus</h2>
	<h2 style="color: blue; font-size: 40px;" align="center">working good</h2>
